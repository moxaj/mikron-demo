...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["Message received: ",cljs.core.cst$kw$value.cljs$core$IFn$_invoke$arity$1((function (){var G__9343 = event.data;
return (seria_demo.common.unpack.cljs$core$IFn$_invoke$arity$1 ? seria_demo.common.unpack.cljs$core$IFn$_invoke$arity$1(G__9343) : seria_demo.common.unpack.call(null,G__9343));
})())], 0));
...
var G__9346 = seria_demo.client.ws_atom;
var G__9347 = seria_demo.websocket.open([cljs.core.str("ws://"),cljs.core.str(location.host)].join(''),seria_demo.client.websocket_callbacks);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__9346,G__9347) : cljs.core.reset_BANG_.call(null,G__9346,G__9347));
});
