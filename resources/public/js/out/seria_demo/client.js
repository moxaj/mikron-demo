...
cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$value.cljs$core$IFn$_invoke$arity$1((function (){var G__13783 = event.data;
return (seria_demo.common.unpack.cljs$core$IFn$_invoke$arity$1 ? seria_demo.common.unpack.cljs$core$IFn$_invoke$arity$1(G__13783) : seria_demo.common.unpack.call(null,G__13783));
})()));
...
var G__13786 = seria_demo.client.ws_atom;
var G__13787 = seria_demo.websocket.open([cljs.core.str("ws://"),cljs.core.str(location.host)].join(''),seria_demo.client.websocket_callbacks);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13786,G__13787) : cljs.core.reset_BANG_.call(null,G__13786,G__13787));
});
